#!/usr/bin/env python
"""
Дифракция Френеля - сферическая волна, круглое отверстие.
"""
import matplotlib
...
root = Tk.Tk()
root.wm_title("Дифракция Френеля - сферическая волна, круглое отверстие.        LP-version = " + LPversion)
...
def openbrowser(event):
    webbrowser.open_new(r"https://github.com/juhnowski/qc_Fresnel_s")
